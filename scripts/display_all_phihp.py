...
def display_agent(model_class,seed, alpha, episodes, env,  receding_horizon, horizon, population, pi_population,selection, PHIHP_role, use_Q, agent_name, model_path, rl_path, directory):
...
if __name__ == "__main__":
        ...
        ######################################     Pendulum   #######################################################
            ...
            display_agent("PhIHP_Pendulum", seed, 1.5, 50, 'pendulum', 1, 5, 200, 20, 10, True, True, "PhIHP", 
            ...
            display_agent("PhIHP_Pendulum", seed, 1.5, 50, 'pendulumsw', 1, 5, 200, 20, 10, True, True, "PhIHP", 
        ...
        ######################################     CARTPOLE   #######################################################
            ...
            display_agent("PhIHP_Cartpole", seed, 0.2, 50, 'ctcartpole', 1, 4, 200, 20, 10, True, True, "PhIHP", 
            ...
            display_agent("PhIHP_Cartpole", seed , 0.03, 50, 'ctcartpolesw', 1, 6, 200, 20, 10, True, True, "PhIHP", 
        ...
        ######################################     Acrobot   #######################################################
            ...
            display_agent("PhIHP_Acrobot", seed, 0.8, 50, 'ctacrobot', 1, 4, 200, 20, 10, True, True,"PhIHP",
            ...
            display_agent("PhIHP_Acrobot_sw", seed, 0.8, 200, 'ctacrobotsw', 1, 3, 200, 20, 10, True, True,"PhIHP", 
