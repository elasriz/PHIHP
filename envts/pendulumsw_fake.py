...
class GymPendulum(gym.Env):
    ...
    def __init__(self, 
                 ...
                 directory: str = "training_model_pendulumsw/episode_10",
                 **kwargs: dict) -> None:
    ...
    def load_dynamics(self, model_class, model_path, **kwargs):
        ...
        #path = self.directory / model_path.format(self.dynamics_model.__class__.__name__, self.model_seed)
        path = os.path.join(self.directory, model_path.format(self.dynamics_model.__class__.__name__, self.model_seed))
    ...
    def predict_transition(self, state, action):
        ...
        #print(new_state[::self.action_repeat, ...].cpu().numpy())
    ...
    def step(self, u):
        ...
        return self._get_obs(), -costs[0][0], False, False, {}
...
register(
    id='im_pendulumsw',
    entry_point='envts.pendulumsw_fake:GymPendulum',
