...
class CtAcrobotEnv(gym.Env):
    ...
    def __init__(self,
                 ...
                 directory: str = "training_model_acrobotsw/episode_30",
                 **kwargs: dict) -> None:
        ...
        self.classenv_name = "ctacrobotsw"
    ...
    def step(self, a):
        ...
        u = torch.tensor(a, dtype=torch.float32).to(self.device)
        ...
        reward = (-cos(self.state[0]) - cos(self.state[1] + self.state[0])) / 2
...
register(
    id='im_ctacrobotsw',
    entry_point='envts.ctacrobotsw_fake:CtAcrobotEnv',
