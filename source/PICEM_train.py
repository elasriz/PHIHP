...
class PICEM(object):
    def __init__(self,
        ...
        self.pi_population = 50 #population
    ...
    def _get_obs(self, state):
        ...
        if self.env.classenv_name == "pendulum":
    ...
    def plan(self, state):
        ...
        if self.use_oracle:
            # env_copy = copy.deepcopy(self.env)  # Do not step the true env, although we could reset it
            env_copy = self.env
        ...
        # 1.bis. Draw sequences of actions from RL politique 
