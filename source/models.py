...
class MLP_acrobot(torch.nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        super().__init__()
        self.linear1 = torch.nn.Linear(input_dim, hidden_dim)
        self.bn1 = nn.BatchNorm1d(hidden_dim)
...
class DynamicsModel_Cartpole(nn.Module):
...
class MLPModel_cartpole(DynamicsModel_Cartpole):
...
class CartPole(DynamicsModel_Cartpole):
...
class AugmentedCartPole(DynamicsModel_Cartpole):
    """
    ...
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        ...
        self.mlp = MLPModel_cartpole(**kwargs)
...
class PhIHP_Cartpole(AugmentedCartPole):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
...
class AugmentedPendulumModel(DynamicsModel):
    ...
    def derivative(self, state, action):
        ...
        self.Fa = self.mlp.derivative(state, action)  # PhIHP augmentation
        return self.Fp + self.Fa
...
class PhIHP_Pendulum(AugmentedPendulumModel):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
...
class MLPModel_ctacrobot(DynamicsModel_acrobot):
    def __init__(self, state_size, action_size, hidden_size=16,  dt=0.2, **kwargs):
        super().__init__(dt=dt, **kwargs)
        self.state_size, self.action_size = state_size, action_size
        self.mlp = MLP_acrobot(state_size + action_size, hidden_size, state_size)
...
class AcrobotModel_sw(DynamicsModel_acrobot):
    def __init__(self, device="cuda", with_friction=True, swingup=True, integration_scheme="symplectic", dt=0.2, **kwargs):
        super().__init__(integration_scheme=integration_scheme, dt=dt, **kwargs)
        self.device = device
    ...
    def derivative(self, state, action): 
        ...
        phi1 = (
            ...
            + (self.m1 * (self.lc1) + self.m2 * self.l1) * self.g * torch.cos(state[:,0] - math.pi/2.0) 
              + (self.m2 * self.lc2 * self.g * torch.cos(state[:, 0] + state[:, 1] - math.pi/2.0))
        )
...
class Acrobot(AcrobotModel_sw):
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        kwargs["swingup"] = False
        super().__init__(**kwargs)


class FrictionlessAcrobot_sw(AcrobotModel_sw):
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        kwargs["with_friction"] = False
        super().__init__(**kwargs)

class FrictionlessAcrobot(AcrobotModel_sw):
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        kwargs["with_friction"] = False
        kwargs["swingup"] = False
        super().__init__(**kwargs)
...
class AugmentedAcrobotModel_sw(DynamicsModel_acrobot):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        super().__init__(integration_scheme=integration_scheme, **kwargs)
        self.device = device
        self.pendulum = FrictionlessAcrobot_sw(**kwargs)
...
class AugmentedAcrobotModel(DynamicsModel_acrobot):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
        super().__init__(integration_scheme=integration_scheme, **kwargs)
        self.device = device
        self.pendulum = FrictionlessAcrobot(**kwargs)
        self.mlp = MLPModel_ctacrobot(**kwargs)
        self.Fa = torch.tensor(0)
        self.Fp = torch.tensor(0)
...
class PhIHP_Acrobot_sw(AugmentedAcrobotModel_sw):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
...
class PhIHP_Acrobot(AugmentedAcrobotModel):
    """
    Frictionless pendulum
    """
    def __init__(self, device="cuda", integration_scheme="symplectic", **kwargs):
