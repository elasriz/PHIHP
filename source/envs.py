...
def env_factory(env_name: str,model_class=None, seed=None) -> Tuple:
    ...
    if env_name == "pendulum":
        ...
        env = gym.make("im_pendulum", model_class=model_class, pointeur=seed)        
        observer = PendulumObserver()
        ...
        env = gym.make("im_pendulumsw", model_class=model_class, pointeur=seed)        
        observer = PendulumObserver()
        ...
        env = gym.make("im_cartpole", model_class=model_class, pointeur=seed)        
        observer = CartpoleObserver()
        ...
        env = gym.make("im_cartpolesw", model_class=model_class, pointeur=seed)        
        observer = CartpoleObserver()
        ...
        env = gym.make("im_ctacrobot", model_class=model_class, pointeur=seed)        
        observer = CartpoleObserver()
        ...
        env = gym.make("im_ctacrobotsw", model_class=model_class, pointeur=seed)        
        observer = CartpoleObserver()
...
class Observer(object):
    ...
    def dt(self, env):
        if hasattr(env, "dmcenv"):
            return env.unwrapped.dmcenv.physics.model.opt.timestep
        elif hasattr(env, "scene"):
            return env.unwrapped.scene.dt
        else:
